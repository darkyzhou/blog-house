...
<nav
  class="flex flex-col items-center md:items-baseline md:flex-row justify-between c-gap c-gap-2 md:c-gap-4 py-4 px-4 sm:px-12 mx-auto w-full">
  <h1 class="text-gray-200 font-bold text-2xl">
    {constraints.base.blogName}
  </h1>
  <ul class="md:mx-4 list-none p-0 flex justify-center c-gap c-gap-2 sm:c-gap-4 text-sm sm:text-base">
