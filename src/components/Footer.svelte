...
<div class="w-full bg-carbongray-900">
  <footer
    class="footer w-full max-w-[960px] mx-auto text-carbongray-300 text-sm py-2 sm:py-4 px-4 sm:px-12 flex justify-between items-end flex-wrap gap-2 {extraClasses}">
