---
title: "[译] 如何打造可被摇树优化的库"
slug: how-to-make-a-tree-shakable-library
date: 2021-06-24T20:16:38.104Z
category: 前端修炼手册
tags:
  - JavaScript
  - Webpack
  - 摇树优化
excerpt: 本文以构建可被摇树优化的库为主线，深入介绍了打包工具（bundler）执行摇树优化的原理，以及一个库适配这种优化的方法。
---

本文由本人翻译，Usualminds 和 KimYangOfCat 校对，并发布在[掘金](https://juejin.cn/post/6977334810536575013)上。
...
![如何打造可被摇树优化的库](/images/uploads/tree-shaking-0.png)
...
网上有很多解释摇树优化和未引用代码移除的文章和资源。这里我们会集中讨论那些应用里中引用的库。当引用一个库的应用能够**成功地移除这个库中未被引用的部分**时，这个库才能被认为做到了摇树优化（tree shakeable）。
 ...
 ![一个可摇树优化的库的例子](/images/uploads/tree-shaking-1.png)
...
![一个摇树优化后的库对应的一张简单的模块图](/images/uploads/tree-shaking-2.jpg)
...
![使用 ESM 格式的库的导出模块图](/images/uploads/tree-shaking-3.jpg)
...
![副作用优化下的模块图](/images/uploads/tree-shaking-4.jpg)
...
![在使用 CJS 格式的依赖时，保留模块结构能够改善摇树优化效果](/images/uploads/tree-shaking-5.jpg)
...
![代码分割导致摇树优化出现的问题](/images/uploads/tree-shaking-6.jpg)
...
![保留模块树可以让 Webpack 独立地对分割的 chunk 进行摇树优化](/images/uploads/tree-shaking-7.jpg)
...
![Webpack的 innerGraph 优化示例](/images/uploads/tree-shaking-8.jpg)
